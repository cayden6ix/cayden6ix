<!-- ╔══════════════════════════════════════════════════════════════╗ -->
<!-- ║  PROFILE README · Paulo Henrique Ghizi                        ║ -->
<!-- ║  Palette: ivory #FBF8F1 · gold #8C6E54 · taupe #A68A64        ║ -->
<!-- ╚══════════════════════════════════════════════════════════════╝ -->
...
<!-- QUOTE -->
<div align="center">
  <i>"You never know how good you might have become unless you try."</i><br/>
  <sub><b>— Mike Mentzer</b></sub>
</div>
...
<div align="center"><h2>🤖 &nbsp;AI-Augmented Engineering</h2></div>

> I treat AI as a **core part of my workflow**, not a shortcut. It amplifies the engineer — it doesn't
...
- 🧱 **Context as infrastructure** — curated project conventions and examples (`CLAUDE.md` / skills) over loose prompts, for consistent and reliable output.
- 🔁 **Short, test-driven loops** — write → run tests → fix; solid testing is what gets the most out of agents.
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/cayden6ix/cayden6ix/output/snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/cayden6ix/cayden6ix/output/snake.svg" />
    <img alt="contribution snake" src="https://raw.githubusercontent.com/cayden6ix/cayden6ix/output/snake.svg" width="100%" />
  </picture>
</div>
